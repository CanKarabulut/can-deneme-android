# Appcircle Sample App for Native (Java/Kotlin) Android Buildsssss
This is a sample Android for testing Android App build functionality in Appcircle. As a Java project, this repository can be used for Android buildssscanmmmm
